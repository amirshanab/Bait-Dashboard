    ...
    return (
        <aside className={styles.sidebar}>
            <ul className={styles.linkList}>
                ...
                <li className={styles.linkItem}><Link to="/add-recipe" className={styles.link}>Add Recipe</Link></li>
                <li className={styles.linkItem}><Link to="/manage-orders" className={styles.link}>Manage Orders</Link></li>
            </ul>
        </aside>
    );
}
